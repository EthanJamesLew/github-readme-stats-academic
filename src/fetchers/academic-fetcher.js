...
/**
 * Fetch academic stats information for a given username.
 *
 ...
 */
const academicStatsFetcher = async (username) => {
  let stats;
...
/**
 * Fetch academic stats for a given username.
 *
 * @param {string} username GitHub username.
 * @param {boolean} count_private Include private contributions.
 * @param {boolean} include_all_commits Include all commits.
 * @returns {Promise<import("./types").AcademicStatsData>} Stats data.
 */
const fetchAcademicStats = async (
  ...
  let res = await academicStatsFetcher(username);
...
export { fetchAcademicStats as fetchAcademicStats };
export default fetchAcademicStats;
